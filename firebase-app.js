...
(function () {
  ...
  function traducirError(code) {
    const map = {
      ...
      'auth/network-request-failed': '⚠️ Conexión bloqueada. Si tienes un adblocker activo (uBlock, AdBlock...), desactívalo para esta página e inténtalo de nuevo.',
    };
    return map[code] || '⚠️ No se pudo conectar. Si tienes un adblocker activo, desactívalo para esta página e inténtalo de nuevo.';
  }
